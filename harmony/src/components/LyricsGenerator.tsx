            ...
            <div className="bg-gray-600 p-8 rounded-lg shadow-md w-[700px]">
                ...
                {lyrics && !loading && (
                    <>
                        ...
                        {!loading && (
                            <div className="flex p-2 rounded-lg justify-center align-center bg-slate-200">
                                <p className="whitespace-pre-line w-full flex p-2 justify-center align-center text-black font-semibold">{lyrics}</p>
